...
5. Understand if performing enrichment analysis will be beneficial for the biological question at hand. 
- Thomas Comment below
- Also the paper that discusses the differences of genes are not metabolites! https://www.nature.com/articles/s42255-025-01283-0 
- Example MetalinksDB to combine with proteomics?

6. In case of combined gene-metabolite data, ...
-different omics sizes: inflate (more significant genes, pathways only with genes, etc.)
