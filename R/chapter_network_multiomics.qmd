...
4.  Examine the mean-sd plot (Figure 1 A and B). The metric informs about the level of homoskedasticity of the dataset. Homoscedasticity is an assumption of parametric tests, e.g. t-tests. In case of sd-mean independence, the running median should be approximately horizontal.
...
ggplot(plotTab, aes(x = F1, y = F2)) +
    ...
    ggnewscale::new_scale_colour() +
    geom_point(aes(color = sex), size = 2) +
    scale_color_manual(values = c(f = "#99a3a2", m = "#b00fe2")) +
    xlab("Factor 1") + ylab("Factor 2") +
    theme_bw()
dev.off()
...
gg_cor_metadata <- image_read("figure/figure2_cor_metadata.png") |>
    image_crop(geometry = "1250x1500+0+200")
