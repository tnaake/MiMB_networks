...
A: Correlation of Factor values across Factors 1-5. 
B: Variance explained for metabolomics and proteomics layers along Factors 1-5.
C: Correlation of MOFA factors with metadata.
D: Scatterplot of factor values for each samples for Factor 1 and Factor 2. Factor 1 separates the samples along the axis NAT-TU.
E: Factor loadings for Factor 1 for metabolomics layer. Shown are the metabolites with the top 10 absolute loadings.
F: 
