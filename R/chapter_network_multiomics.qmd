...
2. Collections of enzymes/molecules and their targets meaning for example kinases and target phosphopeptides, which are usable for footprinitng analysis. Footpriting analysis estimates the activities from molecular readouts of the targets (e.g. phosphosites) downstream of the enzyme (e.g. kinase) [@Dugourd2019].
