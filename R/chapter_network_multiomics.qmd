...
nonsensical results due to the unique characteristics and constraints of 
metabolites compared to genes [@Lee2025]. 
...
- For classical mappings with pathway-metabolite sets, those can be obtained from 
...
- *RaMP-DB* [@Braisted2023] has used *ClassyFire* [@DjoumbouFeunang2016] to assign 
