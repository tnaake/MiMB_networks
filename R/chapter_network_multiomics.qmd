...
For simplicity, we will shocase an example performing a one-versus-one comparison of tumur versus normal:
```{r}
#| eval: true
#| echo: false
#| message: true
...
DMA_Res <- MetaProViz::DMA(InputData= as.data.frame(t(SummarizedExperiment::assay(metabolomics))),
...
Note, when dealing with high number of samples --\> inflation of p-values still persists (see ... for a discussion for RNAseq data). 
