...
7. (optional) Depending on the biological question combine network structure with prior knowledge. For example, analyse the module composition via PK resources to check for metabolite classes. Use one-tailed Fisher's Exact test to check for overrepresentation of a given class.
